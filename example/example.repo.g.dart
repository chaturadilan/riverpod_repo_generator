...
final repoDataGetBooksProvider = FutureProvider.autoDispose
    .family<List<Student>, ({String search, String categoryId})>((ref, arg) {
      return ref
...
final repoDataGetCategoriesProvider = FutureProvider.autoDispose
    .family<List<Hello>, ({String search})>((ref, arg) {
...
final repoDataGetCountryProvider = FutureProvider.autoDispose
    .family<Country, String>((ref, code) {
